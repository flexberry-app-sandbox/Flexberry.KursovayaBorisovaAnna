...
namespace IIS.Kursovaya_Borisova_anna
{
    ...
    public class СоставУслуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya_Borisova_anna.Единицы fЕдиницы;
        
        private IIS.Kursovaya_Borisova_anna.Товар fТовар;
        ...
        public virtual IIS.Kursovaya_Borisova_anna.Единицы Единицы
        {
            get
            {
                ...
                IIS.Kursovaya_Borisova_anna.Единицы result = this.fЕдиницы;
        ...
        [PropertyStorage(new string[] {
                "Товар"})]
        [NotNull()]
        public virtual IIS.Kursovaya_Borisova_anna.Товар Товар
        {
            get
            {
                ...
                IIS.Kursovaya_Borisova_anna.Товар result = this.fТовар;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kursovaya_Borisova_anna.Услуга.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставУслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставУслугиE", typeof(IIS.Kursovaya_Borisova_anna.СоставУслуги));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставУслуги : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kursovaya_Borisova_anna.DetailArrayOfСоставУслуги members)

        // *** End programmer edit section *** (IIS.Kursovaya_Borisova_anna.DetailArrayOfСоставУслуги members)
        ...
        /// </summary>
        public DetailArrayOfСоставУслуги(IIS.Kursovaya_Borisova_anna.Услуга fУслуга) : 
                base(typeof(СоставУслуги), ((ICSSoft.STORMNET.DataObject)(fУслуга)))
        {
        }
        
        public IIS.Kursovaya_Borisova_anna.СоставУслуги this[int index]
        {
            get
            {
                return ((IIS.Kursovaya_Borisova_anna.СоставУслуги)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kursovaya_Borisova_anna.СоставУслуги dataobject)
        {
