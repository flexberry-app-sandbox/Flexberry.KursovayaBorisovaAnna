...
namespace IIS.Kursovaya_Borisova_anna
{
    ...
    public class сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya_Borisova_anna.Пол fПол;
        
        private IIS.Kursovaya_Borisova_anna.Должности fДолжности;
        ...
        public virtual IIS.Kursovaya_Borisova_anna.Пол Пол
        {
            get
            {
                ...
                IIS.Kursovaya_Borisova_anna.Пол result = this.fПол;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Kursovaya_Borisova_anna.Должности Должности
        {
            get
            {
                ...
                IIS.Kursovaya_Borisova_anna.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View сотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("сотрудникE", typeof(IIS.Kursovaya_Borisova_anna.сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View сотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("сотрудникL", typeof(IIS.Kursovaya_Borisova_anna.сотрудник));
                }
            }
        }
    }
